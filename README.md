...
Made as an alternative for the [go-bsb-cams](https://github.com/LilliaElaine/go-bsb-cams) script, you can install a GStreamer plugin to stream webcams into Baballonia.
